...
#define STRING_CONFIG_H_AUTHOR "(Chris Riley SKR 1.4 4-5-2020)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "LOG SKR 1.4"
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (31)    // X point for Z homing when homing all axes (G28).
